...
class Clarion_Customerattribute_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController {
     /*
        @params
        @author Severtek
    ...
    */
    public function viewfileAction() {
        ...
        if (strpos($file, 'jktech_profileimage') !== false) {
            $path = Mage::getBaseDir('media') . DS . 'jktech_profileimage' . DS;
        } else {
