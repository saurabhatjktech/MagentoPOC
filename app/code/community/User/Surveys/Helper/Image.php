 ...
 */
class User_Surveys_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
    ...
    /**
     * Return the base media directory for Surveys Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Surveys Item images
     *
     * @return string
     */
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('user_surveys')->__('Uploaded image is not valid'));
            }
     ...
     *
     * @param User_Surveys_Model_Item $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(User_Surveys_Model_Surveys $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
