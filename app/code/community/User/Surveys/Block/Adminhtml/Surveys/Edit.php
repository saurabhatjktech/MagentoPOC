 ...
 */
class User_Surveys_Block_Adminhtml_Surveys_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        if (Mage::helper('user_surveys/admin')->isActionAllowed('save')) {
            $this->_updateButton('save', 'label', Mage::helper('user_surveys')->__('Save Surveys Item'));
    ...
    public function getHeaderText()
    {
        ...
        if ($model->getId()) {
            return Mage::helper('user_surveys')->__("Edit Surveys Item '%s'",
                 $this->escapeHtml($model->getTitle()));
        } else {
            return Mage::helper('user_surveys')->__('New Surveys Item');
        }
    }
}
