 ...
 */
class Social_Events_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('social_events')->__('Uploaded image is not valid'));
            }
     ...
     *
     * @param Social_Events_Model_Item $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(Social_Events_Model_Events $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
